                ...
                <div className="p-8">
                    <div className="flex justify-between items-start mb-4">
                        <span className={`px-3 py-1 text-[10px] font-bold rounded-full uppercase ${
                            project.status === 'Ativo' ? 'bg-emerald-50 dark:bg-emerald-900/30 text-emerald-800 dark:text-emerald-300 border border-emerald-100 dark:border-emerald-900' : 'bg-gray-100 dark:bg-slate-800 text-gray-600 dark:text-slate-400'
                        }`}>
                            {project.status}
                        </span>
                ...
                <div className="flex items-center justify-between pt-6 border-t border-gray-50 dark:border-slate-800">
                    <div className="text-xs">
                        ...
                        <span className={`font-bold text-2xl ${
                            project.safetyScore >= 90 ? 'text-emerald-600 dark:text-emerald-400' : 'text-yellow-600 dark:text-yellow-400'
